...
_Note that the requirement must use the package [distribution name](https://www.sex.com/pin/57183088-teaching-her-to-behave/) instead
of the module [import name](https://www.sex.com/pin/57183088-teaching-her-to-behave/). For example, the `pyyaml` distribution provides
